...
\paragraph{} The Tyrannosaurus Rex lives among us once again. The time for an incredible experience is now. 
The world will be able to experience something only dreamt of. It will all be possible at the Cretaceous Gardens.
The experience will begin the second the visitor steps off the boat. The visitor will become engulfed in Cretaceous Gardens' unique, technologically advance, and one of a kind luxurious experience.
by the time they leave they will be already planning their next visit. 

\paragraph{} The purpose of this document is to define the requirements for the development of Cretaceous Gardens 
Controller (CGC) for our billionaire philanthropists customers in their new theme park on Isla Trueno near Costa Rica. 
...
\paragraph{}  The rest of this document has five major sections. Section 2 outline the main objectives that will be used to make all decisions moving forward with the project. 
Section 3 describes the overall system organization. This is a fairly high level description of how all pieces will be organized as a whole. Section 4 describes interfaces that are 
 critical for the CGC controller software. They interfaces describe in detail what hardware makes up the interface as well as the features that can be expected from the software aspect. 
 Section 5 describes specific capabilities that the CGC will be able to accomplish. Section 6 will outline all the constraints that are forced upon the CGC system  either by the client or via physical limitations.
 the last section to round out the document is section 7, the definition of terms. Here we find clarification to document specific language that is not immediately clear.\footnote{Introduction by Anas. Feedback updates by Siri.}.  
...
list their sensors, hardware, and features.}
	...
	the physical Pay Kiosks to the CGC. It is composed of sensors and hardware.}
	...
	\begin{list}{}{}
		...
		\item \textbf{Transaction logger:} Will provide receipt to visitors upon purchase and logs transactions in the CGC.
...
\begin{list}{}{}
	...
	\item \textbf{node: }This represents any device connected to the CGC. This includes car, token, and t-rex monitor.
\end{list}
