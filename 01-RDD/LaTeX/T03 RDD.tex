...
\paragraph{} The Tyrannosaurus Rex lives among us once again and the opportunity to provide an incredible experience 
has become a reality. The world will be able to experience that of which, until now, has only been dreamt. The Cretaceous Gardens
experience will begin the second a visitor steps off the boat and onto the Isla Trueno. The visitor will be immersed in Cretaceous 
Gardens' unique, technological advancements: a truly one-of-a-kind luxurious experience. By the time they leave they will be already 
...
The CGC is the main controller for components like the pay kiosks, cars, and electric fence. The CGC must provide
sufficient safety, a great user experience, and ought to efficient.

\paragraph{}  Section \ref{obj} outlines the main objectives of the project, section \ref{sys} the overall system 
organization through a high level depiction, section \ref{int} outlines interfaces, section \ref{cap} contains the capabilities 
of the system, section \ref{con} provides all known design constraints, and the final section provides a reference for potentially
unknown terms within the document \footnote{Introduction by Anas and Siri.}.  
...
here\footnote{Objectives by Anas and Siri.}.}
...
% the outline for a solution
	...
	\begin{enumerate}
		...
		\item The CGC will be able to dynamically account for new nodes in the network or for \textit{nodes} that are
	...
	\begin{enumerate}
		\item The CGC will be able to track all guests at all times in the following ways:
			\begin{enumerate}
				\item Relative to others in their groups.
				\item Relative to their assigned vehicles.
				\item Relative to the whole island.
				\item Relative to their current zone within the island.
			\end{enumerate}
