...
\paragraph{} \textit{Section Introduction}
    ...
    \begin{figure}[H]
 		\centerline{\includegraphics[scale=0.2]{CGCStation.png}}
    ...
    \begin{figure}[H]
 		\centerline{\includegraphics[scale=0.1]{GPSServer.png}}
 		\caption{GPS Server Dynamic Control Model}
  		\label{fig:normal}
    \end{figure}

    \begin{figure}[H]
 		\centerline{\includegraphics[scale=0.1]{GlobalAlarmSystem.png}}
 		\caption{Global Alarm System Dynamic Control Model}
  		\label{fig:normal}
    \end{figure}

    \begin{figure}[H]
 		\centerline{\includegraphics[scale=0.1]{CameraNetwork.png}}
