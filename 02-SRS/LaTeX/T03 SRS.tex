...
\paragraph{} \textit{Section Introduction}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{CGCStation.png}}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{CarNormalMode.png}}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{GPSServer.png}}
         \caption{GPS Server Dynamic Control Model}
          \label{fig:GPS Server}
    \end{figure}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{GlobalAlarmSystem.png}}
         \caption{Global Alarm System Dynamic Control Model}
          \label{fig:Global Alarm System}
    \end{figure}

    \paragraph{Camer Network}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{CameraNetwork.png}}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{ElectricFence.png}}
    ...
    \begin{figure}[H]
         \centerline{\includegraphics[scale=0.15]{T-RexMonitor.png}}
         \caption{T-Rex Monitor Dynamic Control Model}
          \label{fig:T-Rex Monitor}
    \end{figure}
