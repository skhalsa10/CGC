...
\begin{tabularx}{\hsize}{|Y|Y|}
    \hline
    \rowcolor{nicegreen}
    \multicolumn{2}{|c|}{\textbf{Electric Fence}} \\ % Title of Class
    \hline
    \hline
    \multicolumn{2}{|c|}{\textbf{Attributes}}      \\
    \hline
    \textbf{currentMode} & indicates whether or not which mode is detected. \\
    \textbf{healthStatus } & indicates the health of the electric fence. \\
    \textbf{electrical conductance sensor} &  electricity in the fence.\\
    \hline
    ...
    \textbf{reportHealth()} & $\rightarrow$ reports the health of the fence. \\
    \hline
