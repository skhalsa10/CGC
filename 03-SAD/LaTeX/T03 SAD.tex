...
\begin{figure}[H]
    ...
    \caption{An overview of the Cretaceous Gardens Control System.}
 %Red arrows indicate that an object may be triggered by an event. The event is represented by the icon connected to the object.}
